...
@section('content')
<div class="container">
    <h1 class="text-center mt-5 mb-4">Women's Shirts</h1>
    <div class="row">
        @foreach($clothes as $cloth)
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
            <div class="card h-100">
                <img src="{{ asset('images/womens/shirts/' . $cloth->image) }}" class="card-img-top"
                    alt="{{ $cloth->name }}">
                <div class="card-body">
...
<!-- this fixes giant arrows for pagenetion -->
